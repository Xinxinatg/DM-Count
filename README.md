...
The dataset path (line 38), and the name of the folder (line 277) need to be modified in the train_helper.py file. (The folder from os.mkdir('/content/content/content/VisDrone2020-CC/test_data/base_dir_metric_fd') to os.mkdir('/content/content/content/VisDrone2020-CC/test_data/base_dir_metric_cd')) which stores the MAE number from inference) if training on coarse counter.
